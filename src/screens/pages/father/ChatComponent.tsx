...
const styles = StyleSheet.create({
  ...
  headerContent: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 40 },
  ...
  headerTitle: { color: '#fff', fontSize: 32, fontWeight: '800', marginLeft: 10},
  avatarImg: { width: 45, height: 45, borderRadius: 20, marginLeft: '20%' },
  container: { flex: 1 },
